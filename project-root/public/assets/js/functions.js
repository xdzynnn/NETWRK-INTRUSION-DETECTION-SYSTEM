...
$(document).ready(function () {
  ...
  $('.side-nav li, .outer-nav li').click(function (e) {
...
// Remove banner movement logic, if it exists
function updateContent(curPos, nextPos, lastItem) {
  // Other content updates here...

  // Ensure no movement logic is applied to the intro banner
  $('.main-content .intro--banner').css({
  ...
  function outerNav() {
    ...
    $('.outer-nav--return, .outer-nav li').click(function (e) {
      e.preventDefault();
